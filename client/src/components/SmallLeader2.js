...
export default class SmallLeaderBoard2 extends Component {
   constructor(props){
     super(props);
     this.state={
       animate:false,
            ...
            <div className="row" style={{position:"absolute",width:"100%"}}>
              ...
              <div className="col-lg-3" style={{marginTop:"2.3vh",textAlign:"right"}}  >
                ...
                <p style={{fontFamily:"Jura-Regular",fontSize:26,textShadow:"0 0 10px rgba(255, 255, 255, 0.8)", "lineHeight":"normal",
                  "letterSpacing":"normal",
                  "color": "#ffffff",textAlign:"center"}}>{(details.score)?parseInt(details.score):''} 
                  <span style={{fontSize:18,paddingLeft:3}} >PTS</span>
                  </p>
